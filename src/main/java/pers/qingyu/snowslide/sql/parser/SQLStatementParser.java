...
import pers.qingyu.snowslide.sql.ast.statement.SQLCreateTriggerStatement.TriggerType;
...
import pers.qingyu.snowslide.sql.dialect.oracle.parser.OracleExprParser;
import pers.qingyu.snowslide.sql.repository.SchemaRepository;
import pers.qingyu.snowslide.util.FnvHash;
import pers.qingyu.snowslide.util.FnvHash.Constants;
...
import static pers.qingyu.snowslide.sql.parser.Token.ALL;
import static pers.qingyu.snowslide.sql.parser.Token.ALTER;
import static pers.qingyu.snowslide.sql.parser.Token.CASCADE;
import static pers.qingyu.snowslide.sql.parser.Token.COMMA;
import static pers.qingyu.snowslide.sql.parser.Token.GROUP;
import static pers.qingyu.snowslide.sql.parser.Token.LINE_COMMENT;
...
import static pers.qingyu.snowslide.sql.parser.Token.MULTI_LINE_COMMENT;
import static pers.qingyu.snowslide.sql.parser.Token.RESTRICT;
