...
import pers.qingyu.snowslide.sql.dialect.mysql.parser.MySqlLexer;
...
import static pers.qingyu.snowslide.sql.parser.CharTypes.isFirstIdentifierChar;
import static pers.qingyu.snowslide.sql.parser.CharTypes.isIdentifierChar;
import static pers.qingyu.snowslide.sql.parser.CharTypes.isWhitespace;
import static pers.qingyu.snowslide.sql.parser.LayoutCharacters.EOI;
import static pers.qingyu.snowslide.sql.parser.SQLParserFeature.KeepComments;
import static pers.qingyu.snowslide.sql.parser.SQLParserFeature.KeepSourceLocation;
import static pers.qingyu.snowslide.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static pers.qingyu.snowslide.sql.parser.SQLParserFeature.SkipComments;
import static pers.qingyu.snowslide.sql.parser.Token.*;
import static pers.qingyu.snowslide.sql.parser.Token.COLON;
import static pers.qingyu.snowslide.sql.parser.Token.COLONCOLON;
import static pers.qingyu.snowslide.sql.parser.Token.COLONEQ;
import static pers.qingyu.snowslide.sql.parser.Token.COMMA;
import static pers.qingyu.snowslide.sql.parser.Token.DOT;
import static pers.qingyu.snowslide.sql.parser.Token.EOF;
import static pers.qingyu.snowslide.sql.parser.Token.EQ;
import static pers.qingyu.snowslide.sql.parser.Token.EQEQ;
import static pers.qingyu.snowslide.sql.parser.Token.EQGT;
import static pers.qingyu.snowslide.sql.parser.Token.ERROR;
import static pers.qingyu.snowslide.sql.parser.Token.IDENTIFIER;
import static pers.qingyu.snowslide.sql.parser.Token.LBRACE;
import static pers.qingyu.snowslide.sql.parser.Token.LBRACKET;
import static pers.qingyu.snowslide.sql.parser.Token.LITERAL_ALIAS;
import static pers.qingyu.snowslide.sql.parser.Token.LITERAL_CHARS;
import static pers.qingyu.snowslide.sql.parser.Token.LITERAL_PATH;
import static pers.qingyu.snowslide.sql.parser.Token.LPAREN;
import static pers.qingyu.snowslide.sql.parser.Token.RBRACE;
import static pers.qingyu.snowslide.sql.parser.Token.RBRACKET;
import static pers.qingyu.snowslide.sql.parser.Token.RPAREN;
