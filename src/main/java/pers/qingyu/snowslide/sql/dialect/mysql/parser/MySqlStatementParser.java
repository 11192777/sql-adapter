...
import pers.qingyu.snowslide.sql.ast.SQLParameter.ParameterType;
...
import pers.qingyu.snowslide.sql.dialect.mysql.ast.clause.ConditionValue.ConditionType;
...
import pers.qingyu.snowslide.sql.dialect.mysql.ast.statement.MySqlLockTableStatement.LockType;
import pers.qingyu.snowslide.sql.parser.*;
import pers.qingyu.snowslide.sql.repository.SchemaObject;
...
import static pers.qingyu.snowslide.sql.parser.Token.COLUMN;
import static pers.qingyu.snowslide.sql.parser.Token.COMMA;
import static pers.qingyu.snowslide.sql.parser.Token.DATABASE;
import static pers.qingyu.snowslide.sql.parser.Token.EQ;
import static pers.qingyu.snowslide.sql.parser.Token.GROUP;
import static pers.qingyu.snowslide.sql.parser.Token.LPAREN;
import static pers.qingyu.snowslide.sql.parser.Token.RPAREN;
import static pers.qingyu.snowslide.sql.parser.Token.TABLE;
import static pers.qingyu.snowslide.sql.parser.Token.VIEW;
import static pers.qingyu.snowslide.sql.parser.Token.WHERE;
import static pers.qingyu.snowslide.sql.parser.Token.WITH;
