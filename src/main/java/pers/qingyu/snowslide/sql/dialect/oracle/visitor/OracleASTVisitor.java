...
import pers.qingyu.snowslide.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.CycleClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.ModelClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.OracleReturningClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.OracleStorageClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.SampleClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.clause.SearchClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleAnalytic;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleIsOfTypeExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.expr.OracleTreatExpr;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCheck;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCreateSynonymStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleCreateTypeStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleForStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OraclePipeRowStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleRunStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
...
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSelectSubqueryTableSource;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSelectTableReference;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSupplementalIdKey;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleSupplementalLogGrp;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleUnique;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
import pers.qingyu.snowslide.sql.dialect.oracle.ast.stmt.OracleXmlColumnProperties;
